...
export function createProjector({ settings }) {
  ...
  return {
    ...
    // There is deliberately no open() here. Opening the projection window is a
     // link in the page with a target, because window.open is a pop-up and
     // pop-ups are blocked -- silently, returning null. What this object is for
     // is the channel: how many windows are listening, and what they are sent.
